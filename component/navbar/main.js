window.addEventListener('DOMContentLoaded', (event) => {
    ...
    const HeaderComponentPhototcn = document.querySelector('header-component-phototcn');
    if (HeaderComponentPhototcn) {
        const shadow = HeaderComponentPhototcn.shadowRoot;
